    ...
    <div className="flex flex-col lg:flex-row gap-5 lg:gap-0 justify-between items-center mb-20 lg:mb-36">
      <div data-aos="fade-up-right" className="flex flex-col gap-5 lg:w-[50%]">
        ...
        <p className="text-gray-300 text-xl lg:text-2xl ">
          My name is Yogesh, and I am a MERN Stack Developer. I am 30 years old
          from India. I have 7 years of work exprience, focusing and creating
      ...
      <div data-aos="fade-up-left">
        <img
          src={myImg}
          alt="profile"
          className="rounded-full w-[250px] h-[250px] lg:w-[450px] lg:h-[450px] mx-auto"
        />
      </div>
    </div>
  );
